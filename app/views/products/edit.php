...
<html>
<head>
    <title>Edit Product · Tindahan Book</title>
    ...
    <style>
        ...
        *{ box-sizing:border-box; }
        ...
        .tape{
            ...
            width:110px;
            height:34px;
            background:repeating-linear-gradient(45deg, rgba(172,78,55,0.5) 0 8px, rgba(214,163,148,0.5) 8px 16px);
...
<body>
    <div class="wrap">
        ...
        <div class="card">
            ...
            <h1>Edit product</h1>
            <p class="lead">Update the page before it goes back on the shelf.</p>
            <form method="post">
